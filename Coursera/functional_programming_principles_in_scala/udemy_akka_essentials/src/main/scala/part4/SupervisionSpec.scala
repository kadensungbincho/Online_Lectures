...
class SupervisionSpec extends TestKit(ActorSystem("SupervisionSpec"))
  ...
  "A supervisor" should {
    "resume its child in case of a minor fault" in {
      ...
      child ! "This sentence is over 20 characters."
      child ! Report
      expectMsg(3)
    }

    "restart its child in case of ann empty sentence" in {
      val supervisor = system.actorOf(Props[Supervisor])
      supervisor ! Props[FussyWordCounter]
      val child = expectMsgType[ActorRef]
  ...
  class FussyWordCounter extends Actor {
    ...
    override def receive: Receive = {
      ...
      case sentence: String =>
        ...
        else if (!Character.isUpperCase(sentence(0))) throw new IllegalArgumentException("sentennce must start with uppercase")
