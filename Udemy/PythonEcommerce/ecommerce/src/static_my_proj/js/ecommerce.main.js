...
var stripModuleNextUrl = stripeFormModule.attr('data-next-url')
var stripeModuleBtnTitle = stripeFormModule.attr('data-btn-title')

var stripeTemplate = $.templates('#stripeTemplate')
var stripeTemplateDataContext = {
    publishKey: stripeModuleToken,
    nextUrl: stripModuleNextUrl,
    ...
    function stripeTokenHandler(nextUrl, token){
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                card.clear()
                if (nextUrl) {
                    successMsg = successMsg + "<br/><br/><i class='fa fa-spin fa-spinner'></i> directing..."
                }
                if ($.alert){
                    $.alert(successMsg)
                } else {
