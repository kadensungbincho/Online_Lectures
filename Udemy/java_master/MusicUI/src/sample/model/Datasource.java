...
public class Datasource {
    ...
    public static final String CONNECTION_STRING = "jdbc:sqlite:/Users/a1101256/git/kadensungbincho/Online_Lectures/Udemy/java_master/Music/" + DB_NAME;
    ...
    public void insertSong(String title, String artist, String album, int track) {
        try {
            ...
            try {
                ...
                System.out.println("Oh, boy! Things are really bac! " + e2.getMessage());
            }
        } finally {
            try {
